...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="min-h-screen overflow-hidden flex items-center justify-center text-white px-4 sm:px-6 bg-black"
    >
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <img
            src={img_about1}
            alt="Decorative"
            className="absolute -top-10 left-5 sm:left-10 w-24 h-24 sm:w-32 sm:h-32 rounded-3xl shadow-lg z-20"
          />
          <img
            src={img_about2}
            alt="Profile"
          ...
          <img
            src={img_about}
            alt="Decorative"
            className="absolute bottom-0 right-5 sm:right-10 w-20 h-20 sm:w-28 sm:h-28 rounded-3xl shadow-lg z-20"
          />
        </figure>
        ...
        <article
          data-aos="fade-left"
          data-aos-delay="500"
          className="relative z-10 text-center lg:text-left px-2"
        >
          {/* Glowing Circle */}
          <div className="absolute w-40 h-40 sm:w-60 sm:h-60 bg-[#cd3cf5] rounded-full blur-3xl opacity-40 -top-10 -left-10 z-0"></div>

          <h1 className="text-4xl sm:text-5xl font-bold mb-6 z-10 relative">About Me</h1>

          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-6 z-10 relative">
          ...
          <button
            ...
            className="inline-flex items-center justify-center text-white border-2 border-white py-2 px-6 rounded-full hover:bg-[#801b9c] hover:shadow-[0_0_30px_rgba(128,0,128,0.7)] transition duration-300 text-sm sm:text-base"
          >
